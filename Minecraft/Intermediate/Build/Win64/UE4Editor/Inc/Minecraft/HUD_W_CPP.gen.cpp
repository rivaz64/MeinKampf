...
// End Cross Module References
	...
	DEFINE_FUNCTION(UHUD_W_CPP::execSetOwnerPlayer)
	{
	...
	DEFINE_FUNCTION(UHUD_W_CPP::execgetPlayerMaxLife)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(int32*)Z_Param__Result=P_THIS->getPlayerMaxLife();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UHUD_W_CPP::execgetPlayerLife)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(int32*)Z_Param__Result=P_THIS->getPlayerLife();
		P_NATIVE_END;
	}
	void UHUD_W_CPP::StaticRegisterNativesUHUD_W_CPP()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "getPlayerLife", &UHUD_W_CPP::execgetPlayerLife },
			{ "getPlayerMaxLife", &UHUD_W_CPP::execgetPlayerMaxLife },
			{ "SetOwnerPlayer", &UHUD_W_CPP::execSetOwnerPlayer },
	...
	struct Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics
	{
		struct HUD_W_CPP_eventgetPlayerLife_Parms
		{
			int32 ReturnValue;
		};
	...
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HUD_W_CPP_eventgetPlayerLife_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HUD_W_CPP.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UHUD_W_CPP, nullptr, "getPlayerLife", nullptr, nullptr, sizeof(HUD_W_CPP_eventgetPlayerLife_Parms), Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics
	{
		struct HUD_W_CPP_eventgetPlayerMaxLife_Parms
		{
			int32 ReturnValue;
		};
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_ReturnValue;
	...
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HUD_W_CPP_eventgetPlayerMaxLife_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HUD_W_CPP.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UHUD_W_CPP, nullptr, "getPlayerMaxLife", nullptr, nullptr, sizeof(HUD_W_CPP_eventgetPlayerMaxLife_Parms), Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics
	{
		struct HUD_W_CPP_eventSetOwnerPlayer_Parms
		{
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::NewProp__player = { "_player", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HUD_W_CPP_eventSetOwnerPlayer_Parms, _player), Z_Construct_UClass_AMinecraftCharacter_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::NewProp__player,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HUD_W_CPP.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UHUD_W_CPP, nullptr, "SetOwnerPlayer", nullptr, nullptr, sizeof(HUD_W_CPP_eventSetOwnerPlayer_Parms), Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHUD_W_CPP_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHUD_W_CPP_getPlayerLife, "getPlayerLife" }, // 1242805910
		{ &Z_Construct_UFunction_UHUD_W_CPP_getPlayerMaxLife, "getPlayerMaxLife" }, // 3252085952
		{ &Z_Construct_UFunction_UHUD_W_CPP_SetOwnerPlayer, "SetOwnerPlayer" }, // 1466946076
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHUD_W_CPP_Statics::NewProp_Player_MetaData[] = {
		{ "Category", "HUD_W_CPP" },
		{ "ModuleRelativePath", "HUD_W_CPP.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHUD_W_CPP_Statics::NewProp_Player = { "Player", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHUD_W_CPP, Player), Z_Construct_UClass_AMinecraftCharacter_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UHUD_W_CPP_Statics::NewProp_Player_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHUD_W_CPP_Statics::NewProp_Player_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHUD_W_CPP_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHUD_W_CPP_Statics::NewProp_Player,
	};
	...
	IMPLEMENT_CLASS(UHUD_W_CPP, 3596804884);
