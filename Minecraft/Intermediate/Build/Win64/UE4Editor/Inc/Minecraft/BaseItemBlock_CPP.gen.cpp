...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ClassOf_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_ClassOf;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseItemBlock_CPP_Statics::NewProp_ClassOf_MetaData[] = {
		{ "Category", "BaseItemBlock_CPP" },
		{ "ModuleRelativePath", "BaseItemBlock_CPP.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_ABaseItemBlock_CPP_Statics::NewProp_ClassOf = { "ClassOf", nullptr, (EPropertyFlags)0x0014000000000001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseItemBlock_CPP, ClassOf), Z_Construct_UClass_AActor_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_ABaseItemBlock_CPP_Statics::NewProp_ClassOf_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseItemBlock_CPP_Statics::NewProp_ClassOf_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABaseItemBlock_CPP_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABaseItemBlock_CPP_Statics::NewProp_ClassOf,
	};
	...
	IMPLEMENT_CLASS(ABaseItemBlock_CPP, 3077721687);
