...
// End Cross Module References
	...
	DEFINE_FUNCTION(ADropManager_CPP::execSpawnItemFromClass)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SpawnItemFromClass(Z_Param_pos,Z_Param_item,Z_Param_count);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(ADropManager_CPP::execSpawnItemFromType)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SpawnItemFromType(Z_Param_pos,eSPAWN_ITEM_TYPE(Z_Param_type),Z_Param_subType,Z_Param_count);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ADropManager_CPP_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ADropManager_CPP_SpawnItemFromClass, "SpawnItemFromClass" }, // 3680111693
		{ &Z_Construct_UFunction_ADropManager_CPP_SpawnItemFromType, "SpawnItemFromType" }, // 2469698354
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ADropManager_CPP, 3823818490);
